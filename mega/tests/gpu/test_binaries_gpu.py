...
from reference.mega.fairseq_cli import pure_validate_train
...
def _quantize_language_model(data_dir, arch, extra_flags=None, run_validation=False):
    ...
    pure_validate_train.main(train_args)
    ...
    pure_validate_train.main(scalar_quant_train_args)
    ...
    pure_validate_train.main(quantize_args)
