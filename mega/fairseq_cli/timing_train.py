...
def train(args, trainer, task, epoch_itr):
    ...
    for i, samples in enumerate(progress):
        ...
        if end_of_epoch:
            ...
            print(">>> [train_memory (GB)]", round(torch.cuda.max_memory_allocated() / 1024 / 1024 / 1024, 2))
...
def validate(args, trainer, task, epoch_itr, subsets):
    ...
    for subset in subsets:
        ...
        with metrics.aggregate(new_root=True) as agg:
            ...
            print(">>> [validation time] {}".format(end - start))
            print(">>> [validation memory (GB)] {}".format(round(torch.cuda.max_memory_allocated() / 1024 / 1024 / 1024, 2)))
