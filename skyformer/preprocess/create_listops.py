...
train_ds, eval_ds, test_ds, encoder = input_pipeline.get_datasets(
    n_devices = 1, task_name = "basic", data_dir = "/data/jiayan/data/lra_release/lra_release/listops-1000/",
...
for component in mapping:
    ...
    for idx, inst in enumerate(iter(mapping[component])):
        ...
        if idx % 100 == 0:
            print(f"{idx}\t\t", end = "\r")
    with open(f"/data/jiayan/data/lra_processed/lra-listops.{component}.pickle", "wb") as f:
